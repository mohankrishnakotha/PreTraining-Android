...
public class   Program1{
	public static void main(String[] a) {
		...
		Person obj1=new Person("Mohan","VVIT,Nambur");
		System.out.println(obj1.toString());

		Student obj2=new Student("Mohan","VVIT,NAMBUR","B.Tech",4,85000.00);
		System.out.println(obj2.toString());

		Staff obj3=new Staff("Krishna","Vvit, nambur","VIVA School",43162.35);
